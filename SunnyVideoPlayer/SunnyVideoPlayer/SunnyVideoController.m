...
#import "SunnyVideoController.h"
#import <AVFoundation/AVFoundation.h>
#import "SunnyPlayerView.h"


@interface SunnyVideoController ()

/**视频*/
@property (nonatomic ,strong) AVPlayer *player;
@property (nonatomic ,strong) AVPlayerItem *playerItem;
@property (nonatomic ,strong) SunnyPlayerView *playerView;
@property (nonatomic ,strong) id playbackTimeObserver;

/**底部工具条*/
@property (nonatomic,strong) SunnyVideoBottomBar * bottomBar;

/**顶部工具条*/
@property (nonatomic,strong) SunnyVideoTopBar * topBar;

/**中央提示框*/
@property (nonatomic,strong) SunnyVideoLoadingView * centerView;
...
@implementation SunnyVideoController
...
-(SunnyVideoBottomBar *)bottomBar{
    if (!_bottomBar) {
        _bottomBar = [[SunnyVideoBottomBar alloc] initWithFrame:CGRectMake(0, self.cbPlayerView.frame.size.height - 50, self.cbPlayerView.frame.size.width, 50)];
...
-(SunnyVideoTopBar *)topBar{
    if(self.videoType == DVideoTypeTeahcherExp)return nil;
    if (!_topBar) {
        _topBar = [[SunnyVideoTopBar alloc] initWithFrame:CGRectMake(0, 0, self.cbPlayerView.frame.size.width, 50)];
...
- (SunnyVideoLoadingView *)centerView{
    if (!_centerView) {
        ...
        _centerView = [[SunnyVideoLoadingView alloc] initWithFrame:frame andLoadType:type];
...
- (void)setUpVideo
{
    ...
    if (!self.playerView) {
        self.playerView = [[SunnyPlayerView alloc]initWithFrame:self.frame];
